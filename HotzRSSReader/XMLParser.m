...
@interface HTZXMLParser () <NSXMLParserDelegate>
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qualifiedName attributes:(NSDictionary *)attributeDict {
    ...
    if ([self.currentNode objectForKey:elementName]) {
        NSMutableArray *elementsArray = [NSMutableArray arrayWithObjects:[self.currentNode objectForKey:elementName], [HTZXMLParser cleanedAttributes:attributeDict], nil];
        ...
        [currentNode addObject:[HTZXMLParser cleanedAttributes:attributeDict]];
        currentNodeKey = [elementName stringByAppendingString:@"sArray"];
    }
    else {
        currentNodeKey = elementName;
        [self.currentNode setObject:[HTZXMLParser cleanedAttributes:attributeDict] forKey:currentNodeKey];
    }
